...
import ml.easychad.lax.ui.Views.URLSpanNoUnderline;
...
public class MessageObject {
    ...
    public MessageObject(TLRPC.Message message, AbstractMap<Integer, TLRPC.User> users, int preview) {
        ...
        //TODO: Text chat color
        textPaint.setColor(0xFF39294E);
        textPaint.setTextSize(AndroidUtilities.dp(MessagesController.getInstance().fontSize));

        Log.d("B","Text Size: "+MessagesController.getInstance().fontSize);
