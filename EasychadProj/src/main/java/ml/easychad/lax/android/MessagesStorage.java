...
import ml.easychad.lax.SQLite.SQLiteCursor;
import ml.easychad.lax.SQLite.SQLiteDatabase;
import ml.easychad.lax.SQLite.SQLitePreparedStatement;
...
public class MessagesStorage {
    ...
    public TLRPC.ChatParticipants loadChatInfo(final int chat_id){
        TLRPC.ChatParticipants info = null;
