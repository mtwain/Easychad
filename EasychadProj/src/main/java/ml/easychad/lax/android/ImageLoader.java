    ...
    private HashMap<Integer, File> createMediaPaths() {
        ...
        try {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                telegramPath = new File(Environment.getExternalStorageDirectory(), "Easychad");
                telegramPath.mkdirs();
                ...
                if (canRename) {
                    if (telegramPath.isDirectory()) {
                        ...
                        try {
                            File audioPath = new File(telegramPath, "Easychad Audio");
                            audioPath.mkdir();
                        ...
                        try {
                            File documentPath = new File(telegramPath, "Easychad Documents");
                            documentPath.mkdir();
