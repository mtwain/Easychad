...
public class ChatBaseCell extends BaseCell {
    ...
    public ChatBaseCell(Context context) {
        ...
        if (backgroundDrawableIn == null) {
            ...
            timePaintIn.setTextSize(AndroidUtilities.dp(15));
            timePaintIn.setColor(0xffa1aab3);//TODO: колір часу вхідного


            timePaintOut = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            timePaintOut.setTextSize(AndroidUtilities.dp(14));
            timePaintOut.setColor(0xff70b15c);

            timeMediaPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            timeMediaPaint.setTextSize(AndroidUtilities.dp(14));
            ...
            forwardNamePaint.setTextSize(AndroidUtilities.dp(16));
        }
