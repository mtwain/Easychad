...
public class ChatOrUserCell extends BaseCell {
    ...
    private void init() {
        ...
        if (onlinePaint == null) {
            ...
            onlinePaint.setTextSize(AndroidUtilities.dp(18));
            onlinePaint.setColor(0xff316f9f);
        }

        if (offlinePaint == null) {
            offlinePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            offlinePaint.setTextSize(AndroidUtilities.dp(18));
            offlinePaint.setTypeface(AndroidUtilities.getTypeface("fonts/Roboto-Light.ttf"));
