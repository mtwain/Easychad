...
package ml.easychad.lax.ui.Cells;
...
import ml.easychad.lax.android.Emoji;
...
public class DialogCell extends BaseCell {
    ...
    private static Drawable callDrawable;
    ...
    private void init() {
        ...
        if (nameEncryptedPaint == null) {
            ...
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(21));
            nameEncryptedPaint.setColor(0xff00a60e);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface("fonts/Roboto-Light.ttf"));
        }

        if (nameUnknownPaint == null) {
            nameUnknownPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameUnknownPaint.setTextSize(AndroidUtilities.dp(21));
            nameUnknownPaint.setColor(0xff316f9f);
            nameUnknownPaint.setTypeface(AndroidUtilities.getTypeface("fonts/Roboto-Light.ttf"));
        }

        if (messagePaint == null) {
            messagePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            messagePaint.setTextSize(AndroidUtilities.dp(18));
            messagePaint.setTypeface(AndroidUtilities.getTypeface("fonts/Roboto-Light.ttf"));//TODO: message text font
        ...
        if (countPaint == null) {
            ...
            countPaint.setTextSize(AndroidUtilities.dp(14));
        ...
        if (callDrawable == null) {
            callDrawable = getResources().getDrawable(R.drawable.ic_lock_green);
        }
    ...
    private class DialogCellLayout {
        ...
        private int callTop = AndroidUtilities.dp(40);
        ...
        public void build(int width, int height) {
            ...
            //TODO: message width in dialog cell
            messageWidth = width - AndroidUtilities.dp(125);
            if (!LocaleController.isRTL) {
