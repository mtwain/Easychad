...
import ml.easychad.lax.android.ImageReceiver;
import ml.easychad.lax.android.LocaleController;
import ml.easychad.lax.android.MediaController;
import ml.easychad.lax.android.MessageObject;
...
import ml.easychad.lax.ui.Adapters.BaseFragmentAdapter;
import ml.easychad.lax.ui.Cells.ChatActionCell;
import ml.easychad.lax.ui.Cells.ChatAudioCell;
import ml.easychad.lax.ui.Cells.ChatBaseCell;
import ml.easychad.lax.ui.Cells.ChatContactCell;
import ml.easychad.lax.ui.Cells.ChatMediaCell;
import ml.easychad.lax.ui.Cells.ChatMessageCell;
...
import ml.easychad.lax.ui.Views.BackupImageView;
import ml.easychad.lax.ui.Views.ChatActivityEnterView;
import ml.easychad.lax.ui.Views.LayoutListView;
import ml.easychad.lax.ui.Views.SizeNotifierRelativeLayout;
import ml.easychad.lax.ui.Views.TimerButton;
import ml.easychad.lax.ui.Views.TypingDotsDrawable;

public class ChatActivity extends BaseFragment implements ContactsActivity.ContactsActivityDelegate,NotificationCenter.NotificationCenterDelegate, MessagesActivity.MessagesActivityDelegate,
            ...
            actionBarLayer.setActionBarMenuOnItemClick(new ActionBarLayer.ActionBarMenuOnItemClick() {
                ...
                public void onItemClick(int id) {
                    if (id == -1) {
                        ...
                        presentFragment(fragment);
                    } else if (id == attach_user){
                        //TODO:OnClickAttachUser
                        openAddMenu();
                    }else if (id == call_user){
                        //TODO:Call user
                        if(currentUser!=null){
                            Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+"+currentUser.phone));
                            ...
                            for (TLRPC.TL_chatParticipant participant : info.participants) {
                                ...
                                if (sendToUser.phone != user.phone) {
